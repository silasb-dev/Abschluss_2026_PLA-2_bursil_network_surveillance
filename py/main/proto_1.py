...
def run():
    ...
    data = i_forest_t_test.isolation_forest(data,NEW_FEATURE_LIST,contamination=0.16,experimental=False,n_estimators=1000,debug=False)

    # Plot the Data with matplotlib
    cresult = show.show(data,mc_id,debug=False,show=False,v=False)
