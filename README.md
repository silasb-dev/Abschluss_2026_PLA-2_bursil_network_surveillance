...
genutzt werden. Um den zweiten Prototyp zu nutzten, kann man die Datei test_1.py im Ordner py_2/main öffnen und die Variable CAPTURE_FILE auf den
Pfad des zu untersuchenden Capture Files setzten. Danach kann man den Prototyp mit dem Befehl `python -m main.standalone_proto` ausführen, während man im Ordner py_2 ist.